...
# wb1 = openpyxl.load_workbook(filename=template_file_name)  # Відкриваємо шаблонний файл template_file_name
...
# ##################
# data = ['Божко Юрій Володимирович', '16.04.20', 'BOY200416', '07.04.20', '16.04.20', '10', '427.30', '4273.0', 
...
#     [['BOY200416', '07.04.20', 'Проживання в готелі', '3848484', True], ['BOY200416', '07.04.20', 'Проживання в готелі', '3848484', True]], 3848484.0, 3848484.0, 0.0, '', '']
...
# # Зберігання файлу
# file_name = 'example_new'+'.xlsx'
# wb2.save(file_name)  # Ім'я файлу file_name
...
def test_func(data):
  ...
  # Зберігання файлу
  date_name = datetime.now().strftime('__%Y_%m_%d_%H_%M_%S')
  file_type = "AR__"
  extention = ".xlsx"
  file_name = file_type + data_code + date_name + extention
  wb2.save(file_name)  # Ім'я файлу file_name
